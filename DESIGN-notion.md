...
#### Touch Targets
Pill CTAs (`button-primary`, `button-secondary`) and utility buttons (`button-utility`) carry comfortable tap padding; aim for a 44x44px minimum hit area on mobile by preserving vertical padding even as labels shrink.
